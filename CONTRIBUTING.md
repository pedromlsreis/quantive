...
- **Markdown links over backticks** for in-repo file references — most readers see this through the GitHub UI or an IDE that resolves the link.
...
- The crypto module under [`src/lib/crypto/`](src/lib/crypto/) is **MIT** — patches there can be used freely.
