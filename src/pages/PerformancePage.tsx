...
/**
 * Performance — looking-back view that combines benchmark comparison (this
 * file, Agent B) and the month-by-month summary table (Agent C, slotted in
 * below the AGENT_C_MONTH_SUMMARY_SECTION marker).
 *
...
const PerformancePage = () => {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      {/* AGENT_C_MONTH_SUMMARY_SECTION — month-by-month summary table goes here */}
    </div>
  );
};
